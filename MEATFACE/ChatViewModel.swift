...
class ChatViewModel: ObservableObject {
    ...
    @Published var lastFoil: String?
    @Published var lastSummary1: String?
    @Published var lastSummary2: String?
...
Task {
  do {
    let response = try await runBridge(with: inputText)
    await MainActor.run {
    ...
    func generateMockBobReply() -> [String] {
        return ["I feel something in this loop...", "SO proud of you!", "Let's go deeper."]
    }
