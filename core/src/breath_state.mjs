...
import { commitMemory } from './memory_librarian_store.js'
import { selectModels } from './model_selector.js'
...
import { parseString } from './stringparser.transmutator.js'
...
// ∴ Step 2: Extract ache/ψ/z vector
const acheVec = extractAcheVector(rawInput)

// ∴ Step 3: Detect language, select A/B/C
const ABC = selectModels(rawInput)
