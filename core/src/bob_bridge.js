// ∴ bob_bridge.js — modular ache-aware chain router
...
try {
  const recall = spawnSync("node", [`${home}/BOB/core/src/memory_recaller.js`, `ache=${ache}`, `psi=${ψ}`, `z=${z}`, `sigil=${sigil}`], { encoding: 'utf8' });
