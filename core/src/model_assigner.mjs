...
function getModelPool() {
  return [
    ...
    { name: "neural-chat", tags: ["emotional", "summarizer"] },
    ...
    { name: "mixtral", tags: ["general", "chaotic"] },
    { name: "mistral", tags: ["general", "stable"] },
    { name: "mistral-openorca", tags: ["creative", "dialogue"] },
    { name: "codellama", tags: ["code", "compact"] },
    { name: "llama3-groq-tool-use", tags: ["tool", "qa"] },
    { name: "samantha-mistral", tags: ["psych", "reflective"] },
    { name: "ebowwa/cognitive-hacker", tags: ["foil", "chaotic"] },
    { name: "eas/airoboros-m-7b-3.1.2", tags: ["foil", "logic"] }
  ]
}
