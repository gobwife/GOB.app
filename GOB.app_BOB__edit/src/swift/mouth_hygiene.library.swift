...
struct MouthHygiene {
    ...
    let sequence = [
        ...
        "Water floss (✨ universal rec, but ESPECIALLY for step-zero integrity)",
        ...
        "Primary spit.",
        "Water floss – SECOND PASS (💥 implant = required)",
    ...
    let instruction = "cleansing is not symbolic — it is **cache stabilization**"
}
